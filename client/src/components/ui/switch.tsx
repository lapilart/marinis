...
>(({ className, ...props }, ref) => (
  <SwitchPrimitives.Root
    ...
    style={{
      backgroundColor: props.checked ? '#8CB4C4' : undefined
    }}
    {...props}
    ref={ref}
  >
    <SwitchPrimitives.Thumb
      className={cn(
        "pointer-events-none block h-5 w-5 rounded-full bg-yellow-600 shadow-lg ring-0 transition-transform data-[state=checked]:translate-x-5 data-[state=unchecked]:translate-x-0"
      )}
    />
  </SwitchPrimitives.Root>
))
